...
### Detail
No singular photograph can provide all available detail; for example, a ventral view photograph cannot provide a dorsal view, and vice versa. Photographs destroy depth information, but this has been judged an acceptable tradeoff.
...
Wikimedia Commons only allows free (libre; as in freedom) formats; and as all known raw formats are not libre, they cannot be uploaded to Commons. Furthermore, posession of raw files is often considered proof of authorship, further making photographers unwilling to publish them.

Raw files are also storage-intensive. The Internet Archive, or perhaps Zenodo, with its extremely generous 50-gigabyte upload limit, is perhaps a suitable space for this data.

As a matter of transparency, our lead author plans to release RAW files if he takes them himself. However, for moral and legal reasons, he does not plan to photograph dresses in the wild. First, photographing people requires that they give their full informed consent. The LCT-01's identification requirements for wearers is also likely to require information they may not wish to disclose. Second, photographing garments within retail stores may cause awkward or even hostile interactions with staff, which our lead author does not wish for.

Purchasing the garments, at the scale of the taxonomic work conducted by the LCT-01, is also finanically infeasible given the resources available to him. Even if these considerations were resolved, most clothing worn within the lead author's environment is RTW, and their focus for 2026 is mainly on sewing patterns.^[The Philippines has no strong culture of home sewing outside of small-scale repairs. Fully me-made garments such as the Kews are unheard of. This topic is out of this paper's scope, however.]

### Reproducibility
While the process of photographing the garment does not need to be reproducible, the final published image itself must be reproducible and distributable, byte-by-byte. This is strictly in the technical sense. Copyright and moral concerns are inherent to photography, but are irrelevant. Copyright is mitigated by not embedding images in LCT-01 documentation, but rather providing citations to the website on where the holotype is, with a backup link to the Internet Archive. Moral concerns are mitigated by the fact that the images are public, and that the images were invariably taken with the consent of participating subjects.
