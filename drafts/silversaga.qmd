...
* **Annette of B.** &mdash; Annette (Instagram: &commat;[`annette.sews`{.hash}](https://instagram.com/annette.sews))
...
* **E.Grace.J.** &mdash; E. Grace Jones (Instagram: &commat;[`wzrdreams`{.hash}](https://www.instagram.com/wzrdreams)). United States: [New York or New Jersey]. As of 2026-04-16, 177.8 cm (5 ft 10 in) tall; bust 119.38 cm (47 in) [@jones2023].
...
# TODO: Update this tree that is horribly out of date
# TODO: Maybe update it when we finish Argenclara
...
***Argenclara mantorae*** Lemuria, 2026
...
2771&times;4000.
Dorsal view.
White curtain in background. Light source from subject's right.
...
**Taxonomic placement**: Placed in the family Juliettidae.
...
#### Genus *Julietta* {#sec-julietta}
***Julietta*** Lemuria, 2026; gen. nov.

### Family Almidae {#sec-almidae}
**Almidae** Lemuria, 2026; familia nova

**Taxonomic placement**: Placed in the family Almidae.
...
#### Genus *Alma* {#sec-alma}
***Alma*** Lemuria, 2026; gen. nov.

## Class Vecostola {#sec-vecostola}
**Vecostola** Lemuria, 2026

### Family Argentellidae {#sec-argentellidae}
**Argentellidae** Lemuria, 2026; familia nova

**Taxonomic placement**: Placed in the class Vecostola.
...
### Family Argenkamellidae {#sec-argenkamellidae}
**Argenkamellidae** Lemuria, 2026; familia nova

**Etymology**: From *Argenta*, feminine form of Latin *argentum* ("silver") + *ka* from the class Kampylilaimosida as a disambiguator + Ella + *-idae*, family suffix.
...
**Diagnosis**: Phenetically, Helistola is characterized by the presence of bilateral shoulder straps.
...
**Remarks**: The fabric of *Heleonora fraxina* is identical to that of *Liberashira evae* wb. Eva, 2020; as of April 8, 2026, *Tanaflora betsia* is the first fabric to have been observed in two species.
...
### Family Helargemmidae {#sec-helargemmidae}
**Helargemmidae** Lemuria, 2026; familia nova

### Family Helarchloidae {#sec-helarchloidae}
**Helarchloidae** Lemuria, 2026; familia nova

## Class Camisola {#sec-camisola}
**Camisola** Lemuria, 2026; first public desc.

### Order Argentisola {#sec-argentisola}
**Argentisola** Lemuria, 2026; ordo novus

#### Family Francescidae {#sec-francescidae}
**Francescidae** Lemuria, 2026; familia nova
...
### Family Argencoridae {#sec-argencoridae}
**Argencoridae** Lemuria, 2026; familia nova

**Description**: Bilateral double straps, reconfigurable. One single continuous rouleau loop with a single tie, typically at dorsal medial point. Ventral medial plunging V-shaped neckline, terminating inferior to bust. Zipper and ties present dorsally. Ventral medial seam and bilateral horizontal seam at tip of neckline. Bilaterally, two darts on fabric, transitioning into gathers towards superior end. 

::: {#fig-strap-topo-argencoridae}

![](silversaga_supplementary/straptopology.svg)

Multiple diagrams of the possible strap configurations attested amongst the Argencoridae.
Simplified abstract reprojection of garment surface; viewpoint located directly above the wearer's head. The distortion caused by the vertical angle of the fabric has been removed. Another method of conceptualizing this reprojection is to mentally cut the lateral seams apart and lay the dress flat, before placing a circular object to represent the wearer's neck.
Diagram not to scale. Actual distances between strap attachment points not to scale; this diagram focuses solely on shape.
:::

**Remarks**: The Argencoridae, the Cora top, is one of the few discontinued sewing patterns in Silversaga's repertoire. The pattern is attested solely on the Internet Archive.
...
Liberty also reuses names for multiple distinct designs; either the barcode or LCT-01 binomial name can be used for disambiguation.
...
**On floral prints in general.** Biological accuracy is often not a consideration when floral prints. Thus, the botanical descriptions seen in botanical papers is unsuitable as-is, and will require significant modification to accurately describe
